...
export default function ConsolePage() {
  ...
  useEffect(() => {
    document.title = "Console — ADsensei";
  }, []);
  ...
  const handleLoadDemo = () => {
    // Navigate directly to the pre-loaded demo campaign — no upload needed
    router.push("/console/campaigns/d20394fa1ce844a78268570a61881899");
  };
                    ...
                    {profiles.length === 0 ? (
                      <div className="h-full flex items-center justify-center">
                        ...
                        >
                          ...
                          <a
                            href="/sample_profiles.csv"
                            download="sample_profiles.csv"
        ...
        {/* Left Panel - Info */}
          ...
          <div className="mt-10 space-y-3">
            ...
            <button
              ...
              className="w-full py-3.5 bg-[#6366f1] text-white rounded-full text-sm font-medium hover:bg-[#4f46e5] cursor-pointer transition-all"
            >
              Load Demo Campaign
            </button>
            {demoError && <p className="text-xs text-red-400 text-center">{demoError}</p>}
            <a
              href="/sample_profiles.csv"
              download="sample_profiles.csv"
              className="block text-center font-mono text-[10px] uppercase tracking-widest text-muted hover:text-foreground transition-colors py-1"
            >
              Download sample profiles CSV ↓
            </a>
          </div>
